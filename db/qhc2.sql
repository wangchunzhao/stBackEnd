...
(
   ...
   discount             double(5,4) comment '折扣',
   ...
   request_brand        varchar(64) comment '商标要求',
   request_package      varchar(64) comment '木包装要求',
   request_nameplate    varchar(64) comment '铭牌要求',
   request_circult      varchar(64) comment '电路图要求',
...
(
   ...
   body_discount        double(5,4) comment '柜体折扣',
   approved_body_discount double(5,4) comment '批准的柜体折扣',
   main_discount        double(5,4) comment '机组折扣',
   approved_main_discount double(5,4) comment '批准的机组折扣',
   discount             double(5,4) comment '合并折扣',
   is_longterm          integer default 0 comment '是否为长期折扣，1 长期折扣， 0 非长期折扣',
   is_special           integer default 0 comment '是否非统一折扣折扣，1 非统一折扣， 0 统一折扣折扣，同长期折扣',
