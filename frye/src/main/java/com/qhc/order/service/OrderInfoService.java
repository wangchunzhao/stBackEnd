...
public class OrderInfoService {
	...
	public Page<OrderInfo> getKOrdersByConditions(OrderInfo kOrderInfo, Pageable pageable) {
...
/*				if (kOrderInfo.getB2c() > -1) {
	...
	public Page<OrderInfo> getKOrdersByConditions2(OrderInfo kOrderInfo, Pageable pageable) {
		Integer[] ids = {6,7};
		Specification<OrderInfo> specification = new Specification<OrderInfo>() {
