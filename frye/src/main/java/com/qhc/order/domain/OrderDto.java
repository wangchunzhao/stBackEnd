...
public class OrderDto {
	...
	public final static String ORDER_STATUS_SAP_TEMP = "07"; // 下推SAP待确认
	public final static String ORDER_STATUS_SAP_UPGRADE_TEMP = "08"; // 下推SAP待确认
	...
	public final static String ORDER_CUSTOMER_DEALER_CODE="20";
	public final static String ORDER_CUSTOMER_KEY_ACCOUNT_CODE="10";
	...
	private List<DeliveryAddressDto> deliveryAddress;//收货地址
  ...
  public Date getSubmitTime() {
	...
	public void setDeliveryAddress(List<DeliveryAddressDto> deliveryAddress) {
  ...
  public String toString() {
    return "OrderDto [id=" + id + ", orderId=" + orderId + ", createTime=" + createTime
        + ", creater=" + creater + ", createrName=" + createrName + ", updateTime=" + updateTime
        + ", updater=" + updater + ", updaterName=" + updaterName + ", version=" + version
        + ", versionNum=" + versionNum + ", isActive=" + isActive + ", status=" + status
        + ", versions=" + versions + ", userOfficeCode=" + userOfficeCode + ", stOrderType="
        + stOrderType + ", quoteStatus=" + quoteStatus + ", quoteOrderId=" + quoteOrderId
        + ", submitTime=" + submitTime + ", submitBpmTime=" + submitBpmTime + ", orderType="
        + orderType + ", customerCode=" + customerCode + ", customerName=" + customerName
        + ", customerClazz=" + customerClazz + ", customerClazzName=" + customerClazzName
        + ", terminalType=" + terminalType + ", terminalTypeName=" + terminalTypeName
        + ", shopName=" + shopName + ", recordCode=" + recordCode + ", salesCode=" + salesCode
        + ", salesName=" + salesName + ", salesTel=" + salesTel + ", isConvenientStore="
        + isConvenientStore + ", isNew=" + isNew + ", isReformed=" + isReformed
        + ", isYearpurchase=" + isYearpurchase + ", customerIndustryCode=" + customerIndustryCode
        + ", customerIndustryCodeName=" + customerIndustryCodeName + ", customerIndustry="
        + customerIndustry + ", customerIndustryName=" + customerIndustryName + ", sequenceNumber="
        + sequenceNumber + ", contractNumber=" + contractNumber + ", saleType=" + saleType
        + ", taxRate=" + taxRate + ", incoterm=" + incoterm + ", incotermName=" + incotermName
        + ", incotermContect=" + incotermContect + ", contractValue=" + contractValue
        + ", contractRmbValue=" + contractRmbValue + ", currency=" + currency + ", currencyName="
        + currencyName + ", currencyExchange=" + currencyExchange + ", itemsAmount=" + itemsAmount
